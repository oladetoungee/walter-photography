...
export default function HeroSection() {
    return (
        <section className="hero-section relative flex flex-col justify-center space-y-8 md:space-y-12 lg:space-y-16 min-h-[100vh]">
            {/* Background Image */}
            <div 
                ...
                <div className="flex flex-col md:flex-row justify-between items-start px-4 sm:px-6 md:px-12 space-y-8 md:space-y-0 md:space-x-8">
                 ...
                 {/* Branding Section - Left */}
                    <div className="max-w-lg w-full md:w-auto">
                        <h4 className="text-2xl sm:text-3xl md:text-4xl mb-2 font-extrabold text-gray-400">Walter</h4>
                        <p className="text-xs sm:text-sm md:text-xs leading-relaxed  text-gray-100" >
                    ...
                    <div className="grid grid-cols-2 gap-y-4 sm:gap-y-6 gap-x-4 sm:gap-x-6 text-right md:text-left w-full md:w-auto">
                        {[
                            ...
                            <div key={index} className="space-y-1">
                                ...
                                <p className="text-xs font-light text-gray-100">{item.value}</p>
                            </div>
                        ))}
                    </div>
                </div>
